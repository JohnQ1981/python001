...
def count_fails1(*scores):
    ...
    return count
print("*"*50)       
print(count_fails1(45,66,77,44))
print(count_fails1(50,41,47,74,76,81))
print(count_fails1(85,78,91))
print(count_fails1(99,48,79,36))
...
print(get_top_students(kitty=80, blue=95))
